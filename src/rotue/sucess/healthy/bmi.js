...
router.get('/success/healthy/success_bmi',(req,res)=>
{
    if(req.session.username !=undefined)
    {
        ...
        let sql=`SELECT * FROM success_bmi  ORDER BY id`

        con.query(sql,function(err,results,fields)
        {
            if(err) throw err;
            res.render('dashboard/success/healthy/success_bmi',
            {
...
router.post('/show_topic/healthy/table-bmi/sucess_bmi/delete',(req,res)=>
{
    if(req.session.username !=undefined)
    {
        let con =mysql.createConnection(
        ...
        let sql = `DELETE FROM success_bmi WHERE id=?`;
